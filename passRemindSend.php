...
パスワード再発行認証キー入力ページ：http://localhost:8888/monojirou/passRemindRecieve.php
認証キー：{$auth_key}
※認証キーの有効期限は30分となります。

認証キーを再発行されたい場合は下記ページより再度再発行をお願い致します。
http://localhost:8888/monojirou/passRemindSend.php

/////////////////////////////////////////////////
モノジロウカスタマーセンター
URL  http://monojirou.com/
E-mail info@monojirou.com
/////////////////////////////////////////////////
EOT;
          ...
          $_SESSION['auth_key'] = $auth_key;
            ...
            $_SESSION['auth_key_limit'] = time()+(60+30); //現在時刻より３０分後のUNIXタイムスタンプを入れる
